...
from booking.views import TreatmentList, TreatmentDetail, shopping_cart
...
urlpatterns = patterns(
    ...
    url(r'^cart/', shopping_cart, name='cart'),
    url(r'^book/', TreatmentList.as_view(template_name="book.html"), name='book'),
